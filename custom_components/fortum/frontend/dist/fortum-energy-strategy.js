var ar=Object.defineProperty;var xt=(n,t)=>()=>(n&&(t=n(n=0)),t);var Je=(n,t)=>{for(var e in t)ar(n,e,{get:t[e],enumerable:!0})};var Te,Ar,Si,Z,Ne,jt=xt(()=>{Te=n=>typeof n=="number"&&Number.isFinite(n)?String(Math.trunc(n)):typeof n=="string"&&n.trim()||"",Ar=(n,t)=>{let e=/^\d+$/.test(n.number),i=/^\d+$/.test(t.number);return e&&i?Number(n.number)-Number(t.number):e?-1:i?1:n.number.localeCompare(t.number)},Si=n=>n?.states&&typeof n.states=="object"?n.states:n&&typeof n=="object"?n:null,Z=n=>{let t=Si(n);if(!t)return[];let e=new Map;return Object.entries(t).forEach(([i,r])=>{if(!i.startsWith("sensor."))return;let s=Te(r?.attributes?.metering_point_no);if(!s)return;let o=r?.attributes?.address,a=typeof o=="string"?o.trim():"",c=e.get(s);if(!c){e.set(s,{number:s,address:a,label:a?`${a} (${s})`:s,entityIds:[i]});return}!c.address&&a&&(c.address=a,c.label=`${a} (${s})`),c.entityIds.includes(i)||(c.entityIds.push(i),c.entityIds.sort((d,u)=>d.localeCompare(u)))}),Array.from(e.values()).sort(Ar)},Ne=(n,t)=>{let e=Te(t);if(!e)return null;let i=Si(n);if(!i)return null;let r=[];return Object.entries(i).forEach(([s,o])=>{if(!s.startsWith("sensor.")||Te(o?.attributes?.metering_point_no)!==e)return;let c=o?.attributes?.address,d=typeof c=="string"&&c.trim().length>0;r.push({entityId:s,stateObj:o,hasAddress:d})}),r.length?(r.sort((s,o)=>s.hasAddress!==o.hasAddress?s.hasAddress?-1:1:s.entityId.localeCompare(o.entityId)),{entityId:r[0].entityId,stateObj:r[0].stateObj}):null}});var le,Ur,Br,Li,Fe,Gt,Ui,Bi,de,he,Kt=xt(()=>{le=n=>n&&typeof n=="object"&&!Array.isArray(n),Ur=`Valid single strategy example:
...
${t==="multipoint"?Br:Ur}`,Fe=(n,t)=>{if(typeof n=="number"&&Number.isFinite(n))return String(Math.trunc(n));if(typeof n!="string")throw new Error(t+" must be a string.");let e=n.trim();if(!e)throw new Error(t+" must be a non-empty string.");return e},Gt=(n,t)=>{if(n==null)return;if(typeof n!="string")throw new Error(t+" must be a string when provided.");return n.trim()||void 0},Ui=(n,t)=>{if(!Array.isArray(n))throw new Error(t+" must be a list.");return n.map((e,i)=>{if(!le(e))throw new Error(`${t}[${i}] must be an object.`);let r=Fe(e.stat,`${t}[${i}].stat`),s=Gt(e.name,`${t}[${i}].name`);return{stat:r,...s?{name:s}:{}}})},Bi=n=>{if(!le(n))throw new Error("strategy config must be an object.");let t={...n};if(Object.prototype.hasOwnProperty.call(t,"debug")&&typeof t.debug!="boolean")throw new Error("strategy.debug must be a boolean when provided.");if(t.metering_point!==void 0){if(!le(t.metering_point))throw new Error("strategy.metering_point must be an object when provided.");let e={...t.metering_point};e.number!==void 0&&(e.number=Fe(e.number,"strategy.metering_point.number"));let i=Gt(e.name,"strategy.metering_point.name");i?e.name=i:delete e.name;let r=Gt(e.temperature,"strategy.metering_point.temperature");r?e.temperature=r:delete e.temperature,Object.prototype.hasOwnProperty.call(e,"itemization")&&(e.itemization=Ui(e.itemization,"strategy.metering_point.itemization")),t.metering_point=e}return t},de=n=>{try{return Bi(n)}catch(t){let e=t&&t.message?t.message:String(t);throw new Error(Li(e,"single"))}},he=n=>{try{let t=Bi(n);if(!Array.isArray(t.metering_points)||t.metering_points.length===0)throw new Error("strategy.metering_points must be a non-empty list.");return t.metering_points=t.metering_points.map((e,i)=>{if(!le(e))throw new Error(`strategy.metering_points[${i}] must be an object.`);let r=Fe(e.number,`strategy.metering_points[${i}].number`),s=Gt(e.name,`strategy.metering_points[${i}].name`),o=Gt(e.temperature,`strategy.metering_points[${i}].temperature`);if(!Object.prototype.hasOwnProperty.call(e,"itemization"))throw new Error(`strategy.metering_points[${i}].itemization must be a list.`);return{number:r,...s?{name:s}:{},...o?{temperature:o}:{},itemization:Ui(e.itemization,`strategy.metering_points[${i}].itemization`)}}),t}catch(t){let e=t&&t.message?t.message:String(t);throw new Error(Li(e,"multipoint"))}}});var Hr,Mt,Hi,Vi,Oe=xt(()=>{Hr=(n,t)=>Object.prototype.hasOwnProperty.call(n||{},t),Mt=n=>(Array.isArray(n)?n:[]).map(t=>{if(!t||typeof t!="object")return null;let e=typeof t.stat=="string"?t.stat.trim():"";if(!e)return null;let i=typeof t.name=="string"?t.name.trim():"";return{stat:e,...i?{name:i}:{}}}).filter(Boolean),Hi=n=>{let t=n&&typeof n=="object"?{...n}:{},e=t.metering_point&&typeof t.metering_point=="object"?t.metering_point:{},i=typeof e.number=="string"?e.number:"",r=typeof e.name=="string"?e.name:"",s=typeof e.temperature=="string"?e.temperature:"",o=t.debug===!0,a=Hr(e,"itemization"),c=Array.isArray(e.itemization)?e.itemization.map(d=>({stat:typeof d?.stat=="string"?d.stat:"",name:typeof d?.name=="string"?d.name:""})):[];return{baseConfig:t,meteringPointNumber:i,meteringPointName:r,meteringPointTemperature:s,debug:o,hasExplicitItemization:a,itemizationRows:c}},Vi=n=>{let t={...n?.baseConfig&&typeof n.baseConfig=="object"?n.baseConfig:{}},e=t.metering_point&&typeof t.metering_point=="object"?{...t.metering_point}:{},i=typeof n?.meteringPointNumber=="string"?n.meteringPointNumber.trim():"";i?e.number=i:delete e.number;let r=typeof n?.meteringPointName=="string"?n.meteringPointName.trim():"";r?e.name=r:delete e.name;let s=typeof n?.meteringPointTemperature=="string"?n.meteringPointTemperature.trim():"";return s?e.temperature=s:delete e.temperature,n?.debug===!0?t.debug=!0:delete t.debug,n?.hasExplicitItemization?e.itemization=Mt(n.itemizationRows):delete e.itemization,delete t.itemization,delete t.fortum,Object.keys(e).length>0?t.metering_point=e:delete t.metering_point,t}});var ue,Vr,ji,qi,Gi=xt(()=>{Oe();ue=n=>typeof n!="string"?"":n.trim(),Vr=n=>({number:typeof n?.number=="string"||typeof n?.number=="number"?String(n.number).trim():"",name:ue(n?.name),temperature:ue(n?.temperature),itemizationRows:Array.isArray(n?.itemization)?n.itemization.map(t=>({stat:typeof t?.stat=="string"?t.stat:"",name:typeof t?.name=="string"?t.name:""})):[]}),ji=n=>{let t=n&&typeof n=="object"?{...n}:{},e=Array.isArray(t.metering_points)?t.metering_points.map(Vr):[];return{baseConfig:t,debug:t.debug===!0,points:e.length?e:[{number:"",name:"",temperature:"",itemizationRows:[]}]}},qi=n=>{let t={...n?.baseConfig&&typeof n.baseConfig=="object"?n.baseConfig:{}};n?.debug===!0?t.debug=!0:delete t.debug,delete t.itemization;let e=Array.isArray(n?.points)?n.points:[];return t.metering_points=e.map(i=>{let r=typeof i?.number=="string"||typeof i?.number=="number"?String(i.number).trim():"",s=ue(i?.name),o=ue(i?.temperature);return{number:r,...s?{name:s}:{},...o?{temperature:o}:{},itemization:Mt(i?.itemizationRows)}}),t}});var Ki={};Je(Ki,{FortumEnergyMultipointStrategyEditor:()=>Tt});var jr,X,Tt,Le=xt(()=>{Kt();Gi();jt();jr=(n,t)=>{n.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))},X=n=>String(n).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"),Tt=class extends HTMLElement{connectedCallback(){this._maybeEnsureStatisticPickerLoaded()}setConfig(t){if(this._state=ji(t),this._temperatureOverrideEnabledByPoint=this._state.points.map(e=>typeof e?.temperature=="string"&&e.temperature.trim().length>0),this._error="",this._draftErrors={},this._statisticPickerAvailable=!!customElements.get("ha-statistic-picker"),this._skipNextRender){this._skipNextRender=!1;return}this.shadowRoot||this.attachShadow({mode:"open"}),this._render(),this._maybeEnsureStatisticPickerLoaded()}set hass(t){let e=this._hass;this._hass=t,this._meteringPointsChanged(e,t)&&this._render(),this._maybeEnsureStatisticPickerLoaded()}_meteringPointsChanged(t,e){return t?JSON.stringify(Z(t))!==JSON.stringify(Z(e)):!0}_render(){if(!this.shadowRoot||!this._state)return;let t=this._statisticPickerAvailable??!!customElements.get("ha-statistic-picker");this._ensureTemperatureOverrideFlags();let e=this._state.points.map((i,r)=>this._renderPoint(i,r,t)).join("");this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="wrapper">
        ...
        ${this._error?`<div class="error">${X(this._error)}</div>`:""}
      </div>
      ...
      <section class="point" data-point-index="${e}">
        ...
        <div class="field">
          ...
          <select id="point-number-${e}" class="input" data-field="point_number" data-point-index="${e}">
            ...
            ${a?`<option value="${X(a.number)}" selected>${X(a.label)}</option>`:""}
            ${r.map(h=>`<option value="${X(h.number)}" ${h.number===s?"selected":""}>${X(h.label)}</option>`).join("")}
          </select>
          ${c.number?`<div class="hint error-hint">${X(c.number)}</div>`:""}
        </div>

        <div class="field">
          <label class="label" for="point-name-${e}">Display name</label>
          <input id="point-name-${e}" class="input" data-field="point_name" data-point-index="${e}" type="text" placeholder="Name (optional)" value="${X(t?.name||"")}" />
        </div>
        ...
        <div class="field">
          ...
          ${d?i?`<ha-statistic-picker
                    ...
                    data-point-index="${e}"
                    hide-clear-icon
                  ></ha-statistic-picker>`:`<input id="point-temperature-${e}" class="input" data-field="point_temperature" data-point-index="${e}" type="text" placeholder="Temperature source" value="${X(t?.temperature||"")}" />`:""}
        </div>
      ...
      <div class="wrapper">
        <div class="field">
          ...
          >
            ...
            ${s?`<option value="${rt(s.number)}" selected>${rt(s.label)}</option>`:""}
            ${e.map(c=>`<option
                  value="${rt(c.number)}"
                  ${c.number===i?"selected":""}
                >${rt(c.label)}</option>`).join("")}
          </select>
          <div class="hint">
        ...
        <div class="field">
          ...
          <input
            ...
            type="text"
            placeholder="Name (optional)"
            value="${rt(this._state.meteringPointName||"")}"
          />
        </div>
        ...
        <div class="field">
          ...
          ${this._temperatureOverrideEnabled?t?`<ha-statistic-picker
                  ...
                  ></ha-statistic-picker>`:`<input
                    ...
                    value="${rt(this._state.meteringPointTemperature||"")}"
                  />`:""}
        </div>
    ...
    `,this._hasRendered=!0}catch(e){console.error("[fortum-energy] custom legend render failed",e),this.shadowRoot.innerHTML=`
      ...
      `}}};var Qt=globalThis,ee=Qt.ShadowRoot&&(Qt.ShadyCSS===void 0||Qt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ii=Symbol(),ei=new WeakMap,te=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==ii)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(ee&&t===void 0){let i=e!==void 0&&e.length===1;i&&(t=ei.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&ei.set(e,t))}return t}toString(){return this.cssText}},ri=n=>new te(typeof n=="string"?n:n+"",void 0,ii);var si=(n,t)=>{if(ee)n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let i=document.createElement("style"),r=Qt.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=e.cssText,n.appendChild(i)}},ve=ee?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return ri(e)})(n):n;var{is:hr,defineProperty:ur,getOwnPropertyDescriptor:mr,getOwnPropertyNames:pr,getOwnPropertySymbols:gr,getPrototypeOf:_r}=Object,ie=globalThis,ni=ie.trustedTypes,fr=ni?ni.emptyScript:"",yr=ie.reactiveElementPolyfillSupport,Ot=(n,t)=>n,we={toAttribute(n,t){switch(t){case Boolean:n=n?fr:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},ai=(n,t)=>!hr(n,t),oi={attribute:!0,type:String,converter:we,reflect:!1,useDefault:!1,hasChanged:ai};Symbol.metadata??=Symbol("metadata"),ie.litPropertyMetadata??=new WeakMap;var et=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=oi){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),r=this.getPropertyDescriptor(t,i,e);r!==void 0&&ur(this.prototype,t,r)}}static getPropertyDescriptor(t,e,i){let{get:r,set:s}=mr(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:r,set(o){let a=r?.call(this);s?.call(this,o),this.requestUpdate(t,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??oi}static _$Ei(){if(this.hasOwnProperty(Ot("elementProperties")))return;let t=_r(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Ot("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ot("properties"))){let e=this.properties,i=[...pr(e),...gr(e)];for(let r of i)this.createProperty(r,e[r])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[i,r]of e)this.elementProperties.set(i,r)}this._$Eh=new Map;for(let[e,i]of this.elementProperties){let r=this._$Eu(e,i);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let r of i)e.unshift(ve(r))}else t!==void 0&&e.push(ve(t));return e}static _$Eu(t,e){let i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return si(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){let i=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,i);if(r!==void 0&&i.reflect===!0){let s=(i.converter?.toAttribute!==void 0?i.converter:we).toAttribute(e,i.type);this._$Em=t,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$Em=null}}_$AK(t,e){let i=this.constructor,r=i._$Eh.get(t);if(r!==void 0&&this._$Em!==r){let s=i.getPropertyOptions(r),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:we;this._$Em=r;let a=o.fromAttribute(e,s.type);this[r]=a??this._$Ej?.get(r)??a,this._$Em=null}}requestUpdate(t,e,i,r=!1,s){if(t!==void 0){let o=this.constructor;if(r===!1&&(s=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??ai)(s,e)||i.useDefault&&i.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:r,wrapped:s},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??e??this[t]),s!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),r===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,s]of this._$Ep)this[r]=s;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[r,s]of i){let{wrapped:o}=s,a=this[r];o!==!0||this._$AL.has(r)||a===void 0||this.C(r,void 0,s,a)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};et.elementStyles=[],et.shadowRootOptions={mode:"open"},et[Ot("elementProperties")]=new Map,et[Ot("finalized")]=new Map,yr?.({ReactiveElement:et}),(ie.reactiveElementVersions??=[]).push("2.1.2");var Pe=globalThis,ci=n=>n,re=Pe.trustedTypes,li=re?re.createPolicy("lit-html",{createHTML:n=>n}):void 0,gi="$lit$",ct=`lit$${Math.random().toFixed(9).slice(2)}$`,_i="?"+ct,br=`<${_i}>`,gt=document,Ut=()=>gt.createComment(""),Bt=n=>n===null||typeof n!="object"&&typeof n!="function",ke=Array.isArray,vr=n=>ke(n)||typeof n?.[Symbol.iterator]=="function",Se=`[ 	
\f\r]`,Lt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,di=/-->/g,hi=/>/g,mt=RegExp(`>|${Se}(?:([^\\s"'>=/]+)(${Se}*=${Se}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ui=/'/g,mi=/"/g,fi=/^(?:script|style|textarea|title)$/i,De=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),it=De(1),fs=De(2),ys=De(3),_t=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),pi=new WeakMap,pt=gt.createTreeWalker(gt,129);function yi(n,t){if(!ke(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return li!==void 0?li.createHTML(t):t}var wr=(n,t)=>{let e=n.length-1,i=[],r,s=t===2?"<svg>":t===3?"<math>":"",o=Lt;for(let a=0;a<e;a++){let c=n[a],d,u,h=-1,p=0;for(;p<c.length&&(o.lastIndex=p,u=o.exec(c),u!==null);)p=o.lastIndex,o===Lt?u[1]==="!--"?o=di:u[1]!==void 0?o=hi:u[2]!==void 0?(fi.test(u[2])&&(r=RegExp("</"+u[2],"g")),o=mt):u[3]!==void 0&&(o=mt):o===mt?u[0]===">"?(o=r??Lt,h=-1):u[1]===void 0?h=-2:(h=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?mt:u[3]==='"'?mi:ui):o===mi||o===ui?o=mt:o===di||o===hi?o=Lt:(o=mt,r=void 0);let g=o===mt&&n[a+1].startsWith("/>")?" ":"";s+=o===Lt?c+br:h>=0?(i.push(d),c.slice(0,h)+gi+c.slice(h)+ct+g):c+ct+(h===-2?a:g)}return[yi(n,s+(n[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},Ht=class n{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let s=0,o=0,a=t.length-1,c=this.parts,[d,u]=wr(t,e);if(this.el=n.createElement(d,i),pt.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=pt.nextNode())!==null&&c.length<a;){if(r.nodeType===1){if(r.hasAttributes())for(let h of r.getAttributeNames())if(h.endsWith(gi)){let p=u[o++],g=r.getAttribute(h).split(ct),y=/([.?@])?(.*)/.exec(p);c.push({type:1,index:s,name:y[2],strings:g,ctor:y[1]==="."?Ee:y[1]==="?"?Ae:y[1]==="@"?Ce:Ct}),r.removeAttribute(h)}else h.startsWith(ct)&&(c.push({type:6,index:s}),r.removeAttribute(h));if(fi.test(r.tagName)){let h=r.textContent.split(ct),p=h.length-1;if(p>0){r.textContent=re?re.emptyScript:"";for(let g=0;g<p;g++)r.append(h[g],Ut()),pt.nextNode(),c.push({type:2,index:++s});r.append(h[p],Ut())}}}else if(r.nodeType===8)if(r.data===_i)c.push({type:2,index:s});else{let h=-1;for(;(h=r.data.indexOf(ct,h+1))!==-1;)c.push({type:7,index:s}),h+=ct.length-1}s++}}static createElement(t,e){let i=gt.createElement("template");return i.innerHTML=t,i}};function At(n,t,e=n,i){if(t===_t)return t;let r=i!==void 0?e._$Co?.[i]:e._$Cl,s=Bt(t)?void 0:t._$litDirective$;return r?.constructor!==s&&(r?._$AO?.(!1),s===void 0?r=void 0:(r=new s(n),r._$AT(n,e,i)),i!==void 0?(e._$Co??=[])[i]=r:e._$Cl=r),r!==void 0&&(t=At(n,r._$AS(n,t.values),r,i)),t}var xe=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??gt).importNode(e,!0);pt.currentNode=r;let s=pt.nextNode(),o=0,a=0,c=i[0];for(;c!==void 0;){if(o===c.index){let d;c.type===2?d=new Vt(s,s.nextSibling,this,t):c.type===1?d=new c.ctor(s,c.name,c.strings,this,t):c.type===6&&(d=new $e(s,this,t)),this._$AV.push(d),c=i[++a]}o!==c?.index&&(s=pt.nextNode(),o++)}return pt.currentNode=gt,r}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},Vt=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=At(this,t,e),Bt(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==_t&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):vr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==z&&Bt(this._$AH)?this._$AA.nextSibling.data=t:this.T(gt.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Ht.createElement(yi(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{let s=new xe(r,this),o=s.u(this.options);s.p(e),this.T(o),this._$AH=s}}_$AC(t){let e=pi.get(t.strings);return e===void 0&&pi.set(t.strings,e=new Ht(t)),e}k(t){ke(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,r=0;for(let s of t)r===e.length?e.push(i=new n(this.O(Ut()),this.O(Ut()),this,this.options)):i=e[r],i._$AI(s),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=ci(t).nextSibling;ci(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Ct=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,s){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=z}_$AI(t,e=this,i,r){let s=this.strings,o=!1;if(s===void 0)t=At(this,t,e,0),o=!Bt(t)||t!==this._$AH&&t!==_t,o&&(this._$AH=t);else{let a=t,c,d;for(t=s[0],c=0;c<s.length-1;c++)d=At(this,a[i+c],e,c),d===_t&&(d=this._$AH[c]),o||=!Bt(d)||d!==this._$AH[c],d===z?t=z:t!==z&&(t+=(d??"")+s[c+1]),this._$AH[c]=d}o&&!r&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Ee=class extends Ct{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}},Ae=class extends Ct{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}},Ce=class extends Ct{constructor(t,e,i,r,s){super(t,e,i,r,s),this.type=5}_$AI(t,e=this){if((t=At(this,t,e,0)??z)===_t)return;let i=this._$AH,r=t===z&&i!==z||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==z&&(i===z||r);r&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},$e=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){At(this,t)}};var Sr=Pe.litHtmlPolyfillSupport;Sr?.(Ht,Vt),(Pe.litHtmlVersions??=[]).push("3.3.3");var bi=(n,t,e)=>{let i=e?.renderBefore??t,r=i._$litPart$;if(r===void 0){let s=e?.renderBefore??null;i._$litPart$=r=new Vt(t.insertBefore(Ut(),s),s,void 0,e??{})}return r._$AI(n),r};var Ie=globalThis,$t=class extends et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=bi(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _t}};$t._$litElement$=!0,$t.finalized=!0,Ie.litElementHydrateSupport?.({LitElement:$t});var xr=Ie.litElementPolyfillSupport;xr?.({LitElement:$t});(Ie.litElementVersions??=[]).push("4.2.2");var Me=(n,t,e)=>n.localize?.(t)||e,Pt=(n,t=6,e=2)=>{let i=(n||[]).filter(d=>Number.isFinite(d));if(!i.length)return 0;let r=Math.min(...i),s=Math.max(...i),o=s-r;if(o<=0)return Math.abs(s)>0&&Math.abs(s)<1?e:0;let a=o/Math.max(1,t-1);if(!Number.isFinite(a)||a<=0)return 0;let c=Math.ceil(-Math.log10(a));return Math.max(0,Math.min(e,c))},vi=(n,t)=>{let e=/^fortum:price_forecast_([a-z0-9_]+)$/i.exec(n||"");return e?`Price [${String(e[1]||"").toUpperCase()}]`:t===0?"Price":`Price ${t+1}`},kt=(n,t)=>{if(!n||!t)return!1;let e=s=>String(s).split(".").map(o=>parseInt(o,10)||0),i=e(n),r=e(t);for(let s=0;s<Math.max(i.length,r.length);s++){let o=i[s]||0,a=r[s]||0;if(o>a)return!0;if(o<a)return!1}return!0};var Er=n=>typeof n=="string"&&/^[^:]*fortum:hourly_consumption_/.test(n),se=class extends HTMLElement{setConfig(t){this._config=t||{},this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
        <style>
          :host {
            display: block;
            height: 100%;
...
`));let E={importCost:Array.isArray(i.cost)?i.cost.filter(l=>typeof l=="string"&&l.length):[],exportCompensation:[],price:Array.isArray(i.price)?i.price.filter(l=>typeof l=="string"&&l.length):[],temperature:Array.isArray(i.temperature)?i.temperature.filter(l=>typeof l=="string"&&l.length):[]},w={fromGrid:d,toGrid:[],solar:[],fromBattery:[],toBattery:[]},M=this._chart.clientWidth||this.clientWidth||0,m=this._pickBucketMs(e.start,e.end,M,15*60*1e3),f=m<=15*60*1e3?"5minute":"hour",v="hour",A=60*60*1e3;this._energyUnit=g||this._resolveEnergyUnit(t,[...c,...w.fromGrid,...w.toGrid,...w.solar,...w.fromBattery,...w.toBattery]);let P=Array.from(new Set([...w.fromGrid,...E.importCost])),D=await this._fetchStats(c,e.start,e.end,f);if(this._token!==o||f==="5minute"&&c.some(l=>!Array.isArray(D?.[l])||D[l].length===0)&&(f="hour",m=this._pickBucketMs(e.start,e.end,M,60*60*1e3),D=await this._fetchStats(c,e.start,e.end,f),this._token!==o))return;let F=await this._fetchStats(P,e.start,e.end,v);if(this._token!==o)return;let j={...F||{},...D||{}},O={};Object.keys(j||{}).forEach(l=>{O[l]=this._normalizeStatsSeries(j[l])});let $=await this._fetchStats(E.price,e.start,e.end,"hour",["mean"]);if(this._token!==o)return;let Q={};Object.keys($||{}).forEach(l=>{Q[l]=this._normalizePriceSeries($[l])});let yt=await this._fetchStats(E.temperature,e.start,e.end,"hour",["mean"]);if(this._token!==o)return;let Rt={};Object.keys(yt||{}).forEach(l=>{Rt[l]=this._normalizePriceSeries(yt[l])}),this._costUnit="",this._priceUnit="",this._temperatureUnit="";let st=[...E.importCost,...E.exportCompensation,...E.price,...E.temperature];if(st.length)try{let l=await this._fetchStatsMetadata(st);if(this._token!==o)return;let _=[...E.importCost,...E.exportCompensation].map(R=>l[R]?.statistics_unit_of_measurement).find(R=>typeof R=="string"&&R.length),k=E.price.map(R=>l[R]).find(R=>R?.statistics_unit_of_measurement),V=E.temperature.map(R=>l[R]).find(R=>R?.statistics_unit_of_measurement);_&&(this._costUnit=_),k?.statistics_unit_of_measurement&&(this._priceUnit=k.statistics_unit_of_measurement),V?.statistics_unit_of_measurement&&(this._temperatureUnit=V.statistics_unit_of_measurement)}catch{this._costUnit="",this._priceUnit="",this._temperatureUnit=""}let zt=new Map,B=b.map((l,_)=>{let k=l.stat,V=u?.[k]?.statistics_unit_of_measurement,R=this._energyUnitConversionFactor(V,this._energyUnit)||1,St=this._bucketSeries(this._normalizeStatsSeriesWithFactor(D[k],R),m);this._mergeInto(zt,St);let ht=this._getGraphColorByIndex(_);return{id:`adaptive-${k}`,name:this._resolveItemizationName(l,u?.[k]),type:"bar",stack:"consumption",barMaxWidth:50,color:ht,itemStyle:{borderColor:ht,borderWidth:1,borderRadius:[4,4,0,0],opacity:.5},data:[],__bucketMap:St}}),Y=m<A?A:m,lt=new Map,x=new Map,T=new Map,q=new Map,N=new Map;w.fromGrid.forEach(l=>this._mergeInto(lt,this._bucketSeries(O[l]||[],Y))),w.toGrid.forEach(l=>this._mergeInto(x,this._bucketSeries(O[l]||[],Y))),w.solar.forEach(l=>this._mergeInto(T,this._bucketSeries(O[l]||[],Y))),w.fromBattery.forEach(l=>this._mergeInto(q,this._bucketSeries(O[l]||[],Y))),w.toBattery.forEach(l=>this._mergeInto(N,this._bucketSeries(O[l]||[],Y)));let L=new Map;new Set([...lt.keys(),...x.keys(),...T.keys(),...q.keys(),...N.keys()]).forEach(l=>{let _=Math.max(lt.get(l)||0,0)+Math.max(T.get(l)||0,0)+Math.max(q.get(l)||0,0)-Math.max(x.get(l)||0,0)-Math.max(N.get(l)||0,0);L.set(l,_)});let I=new Map;zt.forEach((l,_)=>{let k=this._bucketStart(_,Y);I.set(k,(I.get(k)||0)+l)});let{totalConsumedByBucket:ot,untrackedByBucket:dt}=wi({usedTotalByMathBucket:L,deviceTotalsByMathBucket:I,bucketMs:m,flowBucketMs:A}),bt=new Set([...Array.from(dt.keys()),...Array.from(ot.keys())]);B.forEach(l=>{(l.__bucketMap||new Map).forEach((k,V)=>bt.add(V))});let vt=Array.from(bt).sort((l,_)=>l-_),wt=vt.map(l=>[l,dt.get(l)||0]);B.forEach(l=>{let _=l.__bucketMap||new Map;l.data=vt.map(k=>[k,_.get(k)||0]),delete l.__bucketMap});let Be=this._getUntrackedColor();B.push({id:"adaptive-untracked",name:"Untracked",type:"bar",stack:"consumption",barMaxWidth:50,color:Be,itemStyle:{borderColor:Be,borderWidth:1,borderRadius:[4,4,0,0],opacity:.5},data:wt});let fe=new Map;E.importCost.forEach(l=>{this._mergeInto(fe,this._bucketSeries(O[l]||[],m))}),E.exportCompensation.forEach(l=>{let _=new Map;this._bucketSeries(O[l]||[],m).forEach((k,V)=>{_.set(V,-k)}),this._mergeInto(fe,_)});let Wt=Array.from(fe.entries()).map(([l,_])=>[l,_]).sort((l,_)=>l[0]-_[0]),He=new Map,Ve=new Map;E.price.forEach(l=>{this._accumulateSeriesAverage(Q[l]||[],m,He,Ve)});let Jt=Array.from(He.entries()).map(([l,_])=>[l,_/Math.max(1,Ve.get(l)||1)]).sort((l,_)=>l[0]-_[0]),je=new Map,qe=new Map;E.temperature.forEach(l=>{this._accumulateSeriesAverage(Rt[l]||[],m,je,qe)});let Yt=Array.from(je.entries()).map(([l,_])=>[l,_/Math.max(1,qe.get(l)||1)]).sort((l,_)=>l[0]-_[0]);if(this._costAxisDigits=Pt(Wt.map(l=>Number(l[1]))),this._priceAxisDigits=Pt(Jt.map(l=>Number(l[1]))),this._temperatureAxisDigits=Pt(Yt.map(l=>Number(l[1]))),Wt.length){let l=this._getCostColor();B.push({id:"adaptive-cost-overlay",name:"Cost",type:"line",smooth:.2,symbol:"none",showSymbol:!1,yAxisIndex:1,z:80,lineStyle:{width:2,color:l},itemStyle:{color:l},data:Wt})}if(Jt.length){let l=this._getPriceColor();B.push({id:"adaptive-price-overlay",name:"Price",type:"line",smooth:.05,symbol:"none",showSymbol:!1,yAxisIndex:2,z:79,lineStyle:{width:2,type:"dashed",color:l},itemStyle:{color:l},data:Jt})}if(Yt.length){let l=this._getTemperatureColor(),_=i?.temperature_override?"Temperature (override)":"Temperature";B.push({id:"adaptive-temperature-overlay",name:_,type:"line",smooth:.1,symbol:"none",showSymbol:!1,yAxisIndex:3,z:78,lineStyle:{width:2,type:"dotted",color:l},itemStyle:{color:l},data:Yt})}if(!B.some(l=>Array.isArray(l.data)&&l.data.length)){let l=(this._rangeAttemptCounts?.[r]||0)+1;if(this._rangeAttemptCounts={...this._rangeAttemptCounts||{},[r]:l},l<2){this._queueRetryForRange(r);return}this._showCardError("No consumption data available for the selected range.");return}this._rangeAttemptCounts={...this._rangeAttemptCounts||{},[r]:0};let Ge=this._hass?.locale?.language||"en",Ke=e.end.getTime()-e.start.getTime(),ir=m>=24*60*60*1e3?"1d":m>=60*60*1e3?`${Math.round(m/(60*60*1e3))}h`:"15m",rr={grid:{top:20,bottom:0,left:1,right:1,containLabel:!0},legend:{show:!1,type:"custom",data:[{id:"adaptive-total",secondaryIds:[],name:"Total",itemStyle:{color:"var(--primary-text-color)",borderColor:"var(--primary-text-color)"}},...B.map(l=>{let _=l?.itemStyle?.color||l?.lineStyle?.color||l?.itemStyle?.borderColor||l?.color;return{id:l.id,secondaryIds:[],name:l.name,itemStyle:{color:_,borderColor:_}}})]},xAxis:{type:"time",axisLabel:{formatter:l=>this._formatBucketLabel(Number(l),m,Ke,Ge)}},yAxis:[{type:"value",axisLabel:{formatter:l=>this._energyUnit?`${l} ${this._energyUnit}`:`${l}`}},{type:"value",position:"right",splitLine:{show:!1},axisLabel:{formatter:l=>this._formatCostAxisValue(l)}},{type:"value",position:"right",offset:56,splitLine:{show:!1},axisLabel:{formatter:l=>this._formatPriceAxisValue(l)}},{type:"value",position:"right",offset:112,splitLine:{show:!1},axisLabel:{formatter:l=>this._formatTemperatureAxisValue(l)}}],tooltip:{show:!0,trigger:"axis",formatter:l=>{let _=Array.isArray(l)?l:[l];if(!_.length)return"";let k=Array.isArray(_[0].value)?_[0].value[0]:_[0].value,V=this._bucketStart(Number(k),m),R=`${this._formatBucketLabel(V,m,Ke,Ge)} (${ir})`,St=Number(ot.get(V)||0),ht=this._formatEnergyStatValue(St),K=_.filter(U=>Array.isArray(U.value)&&Math.abs(Number(U.value[1])||0)>0).map(U=>{let tt=Number(U.value[1]),or=U.seriesId==="adaptive-cost-overlay"?this._formatCostValue(tt):U.seriesId==="adaptive-price-overlay"?this._formatPriceValue(tt):U.seriesId==="adaptive-temperature-overlay"?this._formatTemperatureValue(tt):this._energyUnit?`${tt.toFixed(2)} ${this._energyUnit}`:`${tt.toFixed(2)}`;return{marker:U.marker,color:U.color,name:U.seriesName,value:or}});if(kt(this._hass?.config?.version,"2026.6.0")){let U="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;";return it`
    ...
    `,this._boundClick||(this._boundClick=r=>{let s=r.target;if(!(s instanceof Element))return;let o=s.closest("ha-button");if(!o)return;let a=o.getAttribute("data-range");if(a){if(a==="export"){let c=this._config?.collection_key||H;window.dispatchEvent(new CustomEvent("fortum-energy:export-debug-info",{detail:{collectionKey:c,download:!0}}));return}this._setDefaultRange(a)}},this.shadowRoot.addEventListener("click",this._boundClick)),this._rendered=!0}};Le();Ue();var me=class extends HTMLElement{setConfig(t){}getCardSize(){return 1}getGridOptions(){return{rows:1,columns:4}}connectedCallback(){this.style.display="block",this.style.height="100%",this.style.pointerEvents="none"}};Kt();var Ji=/^fortum:hourly_consumption_[a-z0-9_]+$/i,Gr=/^fortum:price_forecast_[a-z0-9_]+$/i,Kr=(n,t)=>Object.prototype.hasOwnProperty.call(n||{},t),Yi=n=>Array.from(new Set((Array.isArray(n)?n:[]).map(t=>typeof t=="string"?t:t?.statistic_id).filter(t=>typeof t=="string"&&t.length))),Wr=n=>{let t=String(n||"").trim().toLowerCase().replace(/[^0-9a-z_]/g,"_").replace(/^_+|_+$/g,"");if(!t)throw new Error("Invalid metering_point.number value.");return t},pe=(n,t)=>`fortum:hourly_${n}_${Wr(t)}`,Jr=n=>{if(typeof n!="string"||!Ji.test(n))throw new Error(`Invalid Fortum consumption statistic id: ${n||"<empty>"}`);return{consumption:n,cost:n.replace("hourly_consumption_","hourly_cost_"),price:n.replace("hourly_consumption_","hourly_price_"),temperature:n.replace("hourly_consumption_","hourly_temperature_")}},Yr=n=>(Array.isArray(n)?n:[]).map(t=>{if(!t||typeof t!="object")return null;let e=typeof t.stat=="string"?t.stat.trim():"";if(!e)return null;let i=typeof t.name=="string"?t.name.trim():"";return{stat:e,...i?{name:i}:{}}}).filter(Boolean),Zr=n=>(Array.isArray(n)?n:[]).map(t=>{if(!t||typeof t!="object")return null;let e=typeof t.stat_consumption=="string"?t.stat_consumption.trim():"";if(!e)return null;let i=typeof t.name=="string"?t.name.trim():"";return{stat:e,...i?{name:i}:{}}}).filter(Boolean),Xr=n=>Yi(n).filter(t=>Ji.test(t)).sort(),Qr=n=>Yi(n).filter(t=>Gr.test(t)).sort(),Zi=({config:n,prefs:t,statisticIds:e})=>{let i=n?.metering_point,r=typeof i?.number=="string"?i.number.trim():"",s="auto",o;if(r)s="yaml",o={consumption:pe("consumption",r),cost:pe("cost",r),price:pe("price",r),temperature:pe("temperature",r)};else{let u=Xr(e);if(!u.length)throw new Error("No Fortum metering point statistics found. Set strategy.metering_point.number.");if(u.length>1)throw new Error(`Single strategy found multiple Fortum metering points: ${u.join(", ")}. Set strategy.metering_point.number.`);o=Jr(u[0])}let a;if(Kr(i,"itemization")){if(!Array.isArray(i.itemization))throw new Error("strategy.metering_point.itemization must be a list when provided.");a=Yr(i.itemization)}else a=Zr(t?.device_consumption);let c=typeof i?.temperature=="string"?i.temperature.trim():"",d=!!c;return{source:s,metrics:{consumption:[o.consumption],cost:[o.cost],price:[o.price],temperature:[c||o.temperature],temperature_override:d,itemizations:a,price_forecast:Qr(e)}}};var ts=(n,t,e=!1,i,r)=>{let s={title:typeof r=="string"&&r.trim()?r.trim():Me(t,"ui.panel.energy.title.electricity","Electricity"),path:"electricity",type:"sections",sections:[]},o=[];return o.push({type:"custom:fortum-energy-spacer-card",grid_options:{columns:6}}),o.push({title:Me(t,"ui.panel.energy.cards.energy_date_selection_title","Time range"),type:"energy-date-selection",collection_key:n,disable_compare:!0,opening_direction:"right",vertical_opening_direction:"down",grid_options:{columns:12}}),o.push({type:"custom:fortum-energy-quick-ranges-card",collection_key:n,debug:e,grid_options:{columns:12}}),o.push({type:"custom:fortum-energy-spacer-card",grid_options:{columns:6}}),o.push({type:"custom:fortum-energy-devices-adaptive-graph-card",collection_key:n,debug:e,resolved_metrics:i,grid_options:{columns:36}}),o.push({title:"Price of Tomorrow",type:"custom:fortum-energy-future-price-card",collection_key:n,debug:e,resolved_metrics:i,grid_options:{columns:36}}),o.push({type:"custom:fortum-energy-spacer-card"}),s.sections.push({type:"grid",column_span:3,cards:o}),s},ft=class extends HTMLElement{static async getConfigElement(){return await Promise.resolve().then(()=>(Ue(),Wi)),document.createElement("fortum-energy-single-strategy-editor")}static async generate(t,e){try{let i=de(t||{}),r=i.collection_key||i.collectionKey||H,s=i.debug===!0,o=await Zt(e),a=typeof i?.metering_point?.number=="string"&&i.metering_point.number.trim().length>0,c=[];try{c=await e.callWS({type:"recorder/list_statistic_ids"})}catch(u){if(!a)throw u}let{metrics:d}=Zi({config:i,prefs:o,statisticIds:c});return{views:[ts(r,e,s,d,i.electricity_title||i?.metering_point?.name)]}}catch(i){return{views:[{title:"Error",path:"error",cards:[{type:"markdown",content:`Error loading fortum-energy strategy:
> ${i&&i.message?i.message:String(i)}`}]}]}}}static async generateDashboard(t){return this.generate(t.strategy||{},t.hass)}},ge=class extends ft{};Kt();jt();var es=n=>typeof n=="number"&&Number.isFinite(n)?String(Math.trunc(n)):typeof n=="string"&&n.trim()||null,Xi=n=>new Set((Array.isArray(n)?n:[]).map(t=>typeof t=="string"?t:t?.statistic_id).filter(t=>typeof t=="string"&&t.length)),Qi=(n,t,e)=>{let i=Ne(n,t);if(!i)return{forecastIds:[],forecastError:`Metering point sensor with metering_point_no=${t} is missing.`};let r=i.entityId,o=i.stateObj?.attributes?.price_area;if(typeof o!="string"||!o.trim())return{forecastIds:[],forecastError:`Sensor ${r} has no attribute price_area.`};let a=`fortum:price_forecast_${o.trim().toLowerCase()}`;return e.has(a)?{forecastIds:[a],forecastError:null}:{forecastIds:[],forecastError:`Price statistic ${a} has no values.`}},tr=(n,t,e)=>(!n||!Array.isArray(n.sections)||n.sections.forEach(i=>{Array.isArray(i?.cards)&&i.cards.forEach(r=>{if(r?.type!=="custom:fortum-energy-future-price-card")return;let s=r.resolved_metrics||{};r.resolved_metrics={...s,price_forecast:t,future_price_error:e}})}),n),er=(n,t)=>(Array.isArray(n?.metering_points)?n.metering_points:[]).map(e=>{let i=es(e.number),s=(i?Ne(t,i):null)?.stateObj?.attributes?.address,o=typeof s=="string"&&s.trim()?s.trim():void 0,a={...n,metering_point:{...n?.metering_point||{}}};return delete a.metering_points,i&&(a.metering_point.number=i),a.metering_point.itemization=e.itemization,e.name?a.metering_point.name=e.name:delete a.metering_point.name,typeof e.temperature=="string"&&e.temperature.trim()?a.metering_point.temperature=e.temperature.trim():delete a.metering_point.temperature,a.electricity_title=e.name||o||e.number,a});var _e=class extends ft{static async getConfigElement(){return await Promise.resolve().then(()=>(Le(),Ki)),document.createElement("fortum-energy-multipoint-strategy-editor")}static async generate(t,e){let i=he(t||{}),r=i.metering_points,s=[];try{s=await e.callWS({type:"recorder/list_statistic_ids"})}catch{s=[]}let o=Xi(s),a=[],c=er(i,e);for(let d=0;d<r.length;d+=1){let u=r[d],h=c[d],p=h?.metering_point?.number||String(u.number),g=await super.generate(h,e),y=Array.isArray(g?.views)?g.views:[],b=y.find(f=>f?.path==="electricity"),S=y[0],E=b||S;if(!E)continue;let{forecastIds:w,forecastError:M}=Qi(e,p,o),m={...E,title:h.electricity_title,path:`electricity-${d+1}`};a.push(tr(m,w,M))}return{views:a}}};var is=()=>{try{let t=new URL(import.meta.url,globalThis?.location?.href).searchParams.get("v");if(typeof t=="string"&&t.trim().length)return t.trim()}catch{}return"unknown"};globalThis.__fortumEnergyIntegrationVersion=is();var J=(n,t)=>{typeof customElements>"u"||customElements.get(n)||customElements.define(n,t)};typeof process<"u"&&process?.versions?.node&&(globalThis.__fortumEnergyStrategyTestHooks={normalizeEnergySourceOverrides:Et,deriveEnergyRuntimeConfig:be});J("fortum-energy-custom-legend-card",Xt);J("fortum-energy-spacer-card",me);J("fortum-energy-quick-ranges-card",ce);J("fortum-energy-devices-detail-overlay-card",se);J("fortum-energy-devices-adaptive-graph-card",oe);J("fortum-energy-future-price-card",ae);J("fortum-energy-single-strategy-editor",Nt);J("fortum-energy-multipoint-strategy-editor",Tt);try{J("ll-strategy-dashboard-fortum-energy-single",ft),J("ll-strategy-dashboard-fortum-energy-multipoint",_e),J("ll-strategy-dashboard-fortum-energy",ge)}catch(n){console.error("[fortum-energy] strategy registration failed",n)}
