var oi=Object.defineProperty;var ot=(n,t)=>()=>(n&&(t=n(n=0)),t);var We=(n,t)=>{for(var e in t)oi(n,e,{get:t[e],enumerable:!0})};var Ae,Ei,wr,mt,Ce,Ct=ot(()=>{Ae=n=>typeof n=="number"&&Number.isFinite(n)?String(Math.trunc(n)):typeof n=="string"&&n.trim()||"",Ei=(n,t)=>{let e=/^\d+$/.test(n.number),r=/^\d+$/.test(t.number);return e&&r?Number(n.number)-Number(t.number):e?-1:r?1:n.number.localeCompare(t.number)},wr=n=>n?.states&&typeof n.states=="object"?n.states:n&&typeof n=="object"?n:null,mt=n=>{let t=wr(n);if(!t)return[];let e=new Map;return Object.entries(t).forEach(([r,i])=>{if(!r.startsWith("sensor."))return;let s=Ae(i?.attributes?.metering_point_no);if(!s)return;let o=i?.attributes?.address,a=typeof o=="string"?o.trim():"",c=e.get(s);if(!c){e.set(s,{number:s,address:a,label:a?`${a} (${s})`:s,entityIds:[r]});return}!c.address&&a&&(c.address=a,c.label=`${a} (${s})`),c.entityIds.includes(r)||(c.entityIds.push(r),c.entityIds.sort((d,u)=>d.localeCompare(u)))}),Array.from(e.values()).sort(Ei)},Ce=(n,t)=>{let e=Ae(t);if(!e)return null;let r=wr(n);if(!r)return null;let i=[];return Object.entries(r).forEach(([s,o])=>{if(!s.startsWith("sensor.")||Ae(o?.attributes?.metering_point_no)!==e)return;let c=o?.attributes?.address,d=typeof c=="string"&&c.trim().length>0;i.push({entityId:s,stateObj:o,hasAddress:d})}),i.length?(i.sort((s,o)=>s.hasAddress!==o.hasAddress?s.hasAddress?-1:1:s.entityId.localeCompare(o.entityId)),{entityId:i[0].entityId,stateObj:i[0].stateObj}):null}});var Kt,Li,Ui,Or,ke,Pt,Lr,Ur,Wt,Yt,kt=ot(()=>{Kt=n=>n&&typeof n=="object"&&!Array.isArray(n),Li=`Valid single strategy example:
...
${t==="multipoint"?Ui:Li}`,ke=(n,t)=>{if(typeof n=="number"&&Number.isFinite(n))return String(Math.trunc(n));if(typeof n!="string")throw new Error(t+" must be a string.");let e=n.trim();if(!e)throw new Error(t+" must be a non-empty string.");return e},Pt=(n,t)=>{if(n==null)return;if(typeof n!="string")throw new Error(t+" must be a string when provided.");return n.trim()||void 0},Lr=(n,t)=>{if(!Array.isArray(n))throw new Error(t+" must be a list.");return n.map((e,r)=>{if(!Kt(e))throw new Error(`${t}[${r}] must be an object.`);let i=ke(e.stat,`${t}[${r}].stat`),s=Pt(e.name,`${t}[${r}].name`);return{stat:i,...s?{name:s}:{}}})},Ur=n=>{if(!Kt(n))throw new Error("strategy config must be an object.");let t={...n};if(Object.prototype.hasOwnProperty.call(t,"debug")&&typeof t.debug!="boolean")throw new Error("strategy.debug must be a boolean when provided.");if(t.metering_point!==void 0){if(!Kt(t.metering_point))throw new Error("strategy.metering_point must be an object when provided.");let e={...t.metering_point};e.number!==void 0&&(e.number=ke(e.number,"strategy.metering_point.number"));let r=Pt(e.name,"strategy.metering_point.name");r?e.name=r:delete e.name;let i=Pt(e.temperature,"strategy.metering_point.temperature");i?e.temperature=i:delete e.temperature,Object.prototype.hasOwnProperty.call(e,"itemization")&&(e.itemization=Lr(e.itemization,"strategy.metering_point.itemization")),t.metering_point=e}return t},Wt=n=>{try{return Ur(n)}catch(t){let e=t&&t.message?t.message:String(t);throw new Error(Or(e,"single"))}},Yt=n=>{try{let t=Ur(n);if(!Array.isArray(t.metering_points)||t.metering_points.length===0)throw new Error("strategy.metering_points must be a non-empty list.");return t.metering_points=t.metering_points.map((e,r)=>{if(!Kt(e))throw new Error(`strategy.metering_points[${r}] must be an object.`);let i=ke(e.number,`strategy.metering_points[${r}].number`),s=Pt(e.name,`strategy.metering_points[${r}].name`),o=Pt(e.temperature,`strategy.metering_points[${r}].temperature`);if(!Object.prototype.hasOwnProperty.call(e,"itemization"))throw new Error(`strategy.metering_points[${r}].itemization must be a list.`);return{number:i,...s?{name:s}:{},...o?{temperature:o}:{},itemization:Lr(e.itemization,`strategy.metering_points[${r}].itemization`)}}),t}catch(t){let e=t&&t.message?t.message:String(t);throw new Error(Or(e,"multipoint"))}}});var Bi,_t,Br,Hr,De=ot(()=>{Bi=(n,t)=>Object.prototype.hasOwnProperty.call(n||{},t),_t=n=>(Array.isArray(n)?n:[]).map(t=>{if(!t||typeof t!="object")return null;let e=typeof t.stat=="string"?t.stat.trim():"";if(!e)return null;let r=typeof t.name=="string"?t.name.trim():"";return{stat:e,...r?{name:r}:{}}}).filter(Boolean),Br=n=>{let t=n&&typeof n=="object"?{...n}:{},e=t.metering_point&&typeof t.metering_point=="object"?t.metering_point:{},r=typeof e.number=="string"?e.number:"",i=typeof e.name=="string"?e.name:"",s=typeof e.temperature=="string"?e.temperature:"",o=t.debug===!0,a=Bi(e,"itemization"),c=Array.isArray(e.itemization)?e.itemization.map(d=>({stat:typeof d?.stat=="string"?d.stat:"",name:typeof d?.name=="string"?d.name:""})):[];return{baseConfig:t,meteringPointNumber:r,meteringPointName:i,meteringPointTemperature:s,debug:o,hasExplicitItemization:a,itemizationRows:c}},Hr=n=>{let t={...n?.baseConfig&&typeof n.baseConfig=="object"?n.baseConfig:{}},e=t.metering_point&&typeof t.metering_point=="object"?{...t.metering_point}:{},r=typeof n?.meteringPointNumber=="string"?n.meteringPointNumber.trim():"";r?e.number=r:delete e.number;let i=typeof n?.meteringPointName=="string"?n.meteringPointName.trim():"";i?e.name=i:delete e.name;let s=typeof n?.meteringPointTemperature=="string"?n.meteringPointTemperature.trim():"";return s?e.temperature=s:delete e.temperature,n?.debug===!0?t.debug=!0:delete t.debug,n?.hasExplicitItemization?e.itemization=_t(n.itemizationRows):delete e.itemization,delete t.itemization,delete t.fortum,Object.keys(e).length>0?t.metering_point=e:delete t.metering_point,t}});var Jt,Hi,Vr,qr,jr=ot(()=>{De();Jt=n=>typeof n!="string"?"":n.trim(),Hi=n=>({number:typeof n?.number=="string"||typeof n?.number=="number"?String(n.number).trim():"",name:Jt(n?.name),temperature:Jt(n?.temperature),itemizationRows:Array.isArray(n?.itemization)?n.itemization.map(t=>({stat:typeof t?.stat=="string"?t.stat:"",name:typeof t?.name=="string"?t.name:""})):[]}),Vr=n=>{let t=n&&typeof n=="object"?{...n}:{},e=Array.isArray(t.metering_points)?t.metering_points.map(Hi):[];return{baseConfig:t,debug:t.debug===!0,points:e.length?e:[{number:"",name:"",temperature:"",itemizationRows:[]}]}},qr=n=>{let t={...n?.baseConfig&&typeof n.baseConfig=="object"?n.baseConfig:{}};n?.debug===!0?t.debug=!0:delete t.debug,delete t.itemization;let e=Array.isArray(n?.points)?n.points:[];return t.metering_points=e.map(r=>{let i=typeof r?.number=="string"||typeof r?.number=="number"?String(r.number).trim():"",s=Jt(r?.name),o=Jt(r?.temperature);return{number:i,...s?{name:s}:{},...o?{temperature:o}:{},itemization:_t(r?.itemizationRows)}}),t}});var Gr={};We(Gr,{FortumEnergyMultipointStrategyEditor:()=>ft});var Vi,V,ft,Ie=ot(()=>{kt();jr();Ct();Vi=(n,t)=>{n.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))},V=n=>String(n).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"),ft=class extends HTMLElement{connectedCallback(){this._maybeEnsureStatisticPickerLoaded()}setConfig(t){this._state=Vr(t),this._temperatureOverrideEnabledByPoint=this._state.points.map(e=>typeof e?.temperature=="string"&&e.temperature.trim().length>0),this._error="",this._draftErrors={},this._statisticPickerAvailable=!!customElements.get("ha-statistic-picker"),this.shadowRoot||this.attachShadow({mode:"open"}),this._render(),this._maybeEnsureStatisticPickerLoaded()}set hass(t){this._hass=t,this._applyStatisticPickerProps(),this._render(),this._maybeEnsureStatisticPickerLoaded()}_render(){if(!this.shadowRoot||!this._state)return;let t=this._statisticPickerAvailable??!!customElements.get("ha-statistic-picker");this._ensureTemperatureOverrideFlags();let e=this._state.points.map((r,i)=>this._renderPoint(r,i,t)).join("");this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="wrapper">
        ...
        ${this._error?`<div class="error">${V(this._error)}</div>`:""}
      </div>
      ...
      <section class="point" data-point-index="${e}">
        ...
        <div class="field">
          ...
          <select id="point-number-${e}" class="input" data-field="point_number" data-point-index="${e}">
            ...
            ${a?`<option value="${V(a.number)}" selected>${V(a.label)}</option>`:""}
            ${i.map(h=>`<option value="${V(h.number)}" ${h.number===s?"selected":""}>${V(h.label)}</option>`).join("")}
          </select>
          ${c.number?`<div class="hint error-hint">${V(c.number)}</div>`:""}
        </div>

        <div class="field">
          <label class="label" for="point-name-${e}">Display name</label>
          <input id="point-name-${e}" class="input" data-field="point_name" data-point-index="${e}" type="text" placeholder="Name (optional)" value="${V(t?.name||"")}" />
        </div>
        ...
        <div class="field">
          ...
          ${d?r?`<ha-statistic-picker
                    ...
                    data-point-index="${e}"
                    hide-clear-icon
                  ></ha-statistic-picker>`:`<input id="point-temperature-${e}" class="input" data-field="point_temperature" data-point-index="${e}" type="text" placeholder="Temperature source" value="${V(t?.temperature||"")}" />`:""}
        </div>
      ...
      <div class="wrapper">
        <div class="field">
          ...
          >
            ...
            ${s?`<option value="${K(s.number)}" selected>${K(s.label)}</option>`:""}
            ${e.map(c=>`<option
                  value="${K(c.number)}"
                  ${c.number===r?"selected":""}
                >${K(c.label)}</option>`).join("")}
          </select>
          <div class="hint">
        ...
        <div class="field">
          ...
          <input
            ...
            type="text"
            placeholder="Name (optional)"
            value="${K(this._state.meteringPointName||"")}"
          />
        </div>
        ...
        <div class="field">
          ...
          ${this._temperatureOverrideEnabled?t?`<ha-statistic-picker
                  ...
                  ></ha-statistic-picker>`:`<input
                    ...
                    value="${K(this._state.meteringPointTemperature||"")}"
                  />`:""}
        </div>
    ...
    `,this._hasRendered=!0}catch(e){console.error("[fortum-energy] custom legend render failed",e),this.shadowRoot.innerHTML=`
      ...
      `}}};var Ft=globalThis,Lt=Ft.ShadowRoot&&(Ft.ShadyCSS===void 0||Ft.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,er=Symbol(),tr=new WeakMap,Ot=class{constructor(t,e,r){if(this._$cssResult$=!0,r!==er)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(Lt&&t===void 0){let r=e!==void 0&&e.length===1;r&&(t=tr.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&tr.set(e,t))}return t}toString(){return this.cssText}},rr=n=>new Ot(typeof n=="string"?n:n+"",void 0,er);var ir=(n,t)=>{if(Lt)n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let r=document.createElement("style"),i=Ft.litNonce;i!==void 0&&r.setAttribute("nonce",i),r.textContent=e.cssText,n.appendChild(r)}},ue=Lt?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(let r of t.cssRules)e+=r.cssText;return rr(e)})(n):n;var{is:di,defineProperty:hi,getOwnPropertyDescriptor:ui,getOwnPropertyNames:mi,getOwnPropertySymbols:pi,getPrototypeOf:gi}=Object,Ut=globalThis,sr=Ut.trustedTypes,_i=sr?sr.emptyScript:"",fi=Ut.reactiveElementPolyfillSupport,vt=(n,t)=>n,me={toAttribute(n,t){switch(t){case Boolean:n=n?_i:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},or=(n,t)=>!di(n,t),nr={attribute:!0,type:String,converter:me,reflect:!1,useDefault:!1,hasChanged:or};Symbol.metadata??=Symbol("metadata"),Ut.litPropertyMetadata??=new WeakMap;var j=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=nr){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let r=Symbol(),i=this.getPropertyDescriptor(t,r,e);i!==void 0&&hi(this.prototype,t,i)}}static getPropertyDescriptor(t,e,r){let{get:i,set:s}=ui(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:i,set(o){let a=i?.call(this);s?.call(this,o),this.requestUpdate(t,a,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??nr}static _$Ei(){if(this.hasOwnProperty(vt("elementProperties")))return;let t=gi(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(vt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(vt("properties"))){let e=this.properties,r=[...mi(e),...pi(e)];for(let i of r)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[r,i]of e)this.elementProperties.set(r,i)}this._$Eh=new Map;for(let[e,r]of this.elementProperties){let i=this._$Eu(e,r);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let r=new Set(t.flat(1/0).reverse());for(let i of r)e.unshift(ue(i))}else t!==void 0&&e.push(ue(t));return e}static _$Eu(t,e){let r=e.attribute;return r===!1?void 0:typeof r=="string"?r:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let r of e.keys())this.hasOwnProperty(r)&&(t.set(r,this[r]),delete this[r]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ir(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,r){this._$AK(t,r)}_$ET(t,e){let r=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,r);if(i!==void 0&&r.reflect===!0){let s=(r.converter?.toAttribute!==void 0?r.converter:me).toAttribute(e,r.type);this._$Em=t,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(t,e){let r=this.constructor,i=r._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let s=r.getPropertyOptions(i),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:me;this._$Em=i;let a=o.fromAttribute(e,s.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(t,e,r,i=!1,s){if(t!==void 0){let o=this.constructor;if(i===!1&&(s=this[t]),r??=o.getPropertyOptions(t),!((r.hasChanged??or)(s,e)||r.useDefault&&r.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,r))))return;this.C(t,e,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:r,reflect:i,wrapped:s},o){r&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??e??this[t]),s!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||r||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}let r=this.constructor.elementProperties;if(r.size>0)for(let[i,s]of r){let{wrapped:o}=s,a=this[i];o!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,s,a)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(r=>r.hostUpdate?.()),this.update(e)):this._$EM()}catch(r){throw t=!1,this._$EM(),r}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};j.elementStyles=[],j.shadowRootOptions={mode:"open"},j[vt("elementProperties")]=new Map,j[vt("finalized")]=new Map,fi?.({ReactiveElement:j}),(Ut.reactiveElementVersions??=[]).push("2.1.2");var ve=globalThis,ar=n=>n,Bt=ve.trustedTypes,cr=Bt?Bt.createPolicy("lit-html",{createHTML:n=>n}):void 0,pr="$lit$",Y=`lit$${Math.random().toFixed(9).slice(2)}$`,gr="?"+Y,yi=`<${gr}>`,et=document,St=()=>et.createComment(""),xt=n=>n===null||typeof n!="object"&&typeof n!="function",we=Array.isArray,bi=n=>we(n)||typeof n?.[Symbol.iterator]=="function",pe=`[ 	
\f\r]`,wt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,lr=/-->/g,dr=/>/g,Q=RegExp(`>|${pe}(?:([^\\s"'>=/]+)(${pe}*=${pe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),hr=/'/g,ur=/"/g,_r=/^(?:script|style|textarea|title)$/i,Se=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),G=Se(1),fs=Se(2),ys=Se(3),rt=Symbol.for("lit-noChange"),I=Symbol.for("lit-nothing"),mr=new WeakMap,tt=et.createTreeWalker(et,129);function fr(n,t){if(!we(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return cr!==void 0?cr.createHTML(t):t}var vi=(n,t)=>{let e=n.length-1,r=[],i,s=t===2?"<svg>":t===3?"<math>":"",o=wt;for(let a=0;a<e;a++){let c=n[a],d,u,h=-1,_=0;for(;_<c.length&&(o.lastIndex=_,u=o.exec(c),u!==null);)_=o.lastIndex,o===wt?u[1]==="!--"?o=lr:u[1]!==void 0?o=dr:u[2]!==void 0?(_r.test(u[2])&&(i=RegExp("</"+u[2],"g")),o=Q):u[3]!==void 0&&(o=Q):o===Q?u[0]===">"?(o=i??wt,h=-1):u[1]===void 0?h=-2:(h=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?Q:u[3]==='"'?ur:hr):o===ur||o===hr?o=Q:o===lr||o===dr?o=wt:(o=Q,i=void 0);let p=o===Q&&n[a+1].startsWith("/>")?" ":"";s+=o===wt?c+yi:h>=0?(r.push(d),c.slice(0,h)+pr+c.slice(h)+Y+p):c+Y+(h===-2?a:p)}return[fr(n,s+(n[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},Et=class n{constructor({strings:t,_$litType$:e},r){let i;this.parts=[];let s=0,o=0,a=t.length-1,c=this.parts,[d,u]=vi(t,e);if(this.el=n.createElement(d,r),tt.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(i=tt.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let h of i.getAttributeNames())if(h.endsWith(pr)){let _=u[o++],p=i.getAttribute(h).split(Y),y=/([.?@])?(.*)/.exec(_);c.push({type:1,index:s,name:y[2],strings:p,ctor:y[1]==="."?_e:y[1]==="?"?fe:y[1]==="@"?ye:lt}),i.removeAttribute(h)}else h.startsWith(Y)&&(c.push({type:6,index:s}),i.removeAttribute(h));if(_r.test(i.tagName)){let h=i.textContent.split(Y),_=h.length-1;if(_>0){i.textContent=Bt?Bt.emptyScript:"";for(let p=0;p<_;p++)i.append(h[p],St()),tt.nextNode(),c.push({type:2,index:++s});i.append(h[_],St())}}}else if(i.nodeType===8)if(i.data===gr)c.push({type:2,index:s});else{let h=-1;for(;(h=i.data.indexOf(Y,h+1))!==-1;)c.push({type:7,index:s}),h+=Y.length-1}s++}}static createElement(t,e){let r=et.createElement("template");return r.innerHTML=t,r}};function ct(n,t,e=n,r){if(t===rt)return t;let i=r!==void 0?e._$Co?.[r]:e._$Cl,s=xt(t)?void 0:t._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(n),i._$AT(n,e,r)),r!==void 0?(e._$Co??=[])[r]=i:e._$Cl=i),i!==void 0&&(t=ct(n,i._$AS(n,t.values),i,r)),t}var ge=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:r}=this._$AD,i=(t?.creationScope??et).importNode(e,!0);tt.currentNode=i;let s=tt.nextNode(),o=0,a=0,c=r[0];for(;c!==void 0;){if(o===c.index){let d;c.type===2?d=new At(s,s.nextSibling,this,t):c.type===1?d=new c.ctor(s,c.name,c.strings,this,t):c.type===6&&(d=new be(s,this,t)),this._$AV.push(d),c=r[++a]}o!==c?.index&&(s=tt.nextNode(),o++)}return tt.currentNode=et,i}p(t){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}},At=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,i){this.type=2,this._$AH=I,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=ct(this,t,e),xt(t)?t===I||t==null||t===""?(this._$AH!==I&&this._$AR(),this._$AH=I):t!==this._$AH&&t!==rt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):bi(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==I&&xt(this._$AH)?this._$AA.nextSibling.data=t:this.T(et.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:r}=t,i=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=Et.createElement(fr(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===i)this._$AH.p(e);else{let s=new ge(i,this),o=s.u(this.options);s.p(e),this.T(o),this._$AH=s}}_$AC(t){let e=mr.get(t.strings);return e===void 0&&mr.set(t.strings,e=new Et(t)),e}k(t){we(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,i=0;for(let s of t)i===e.length?e.push(r=new n(this.O(St()),this.O(St()),this,this.options)):r=e[i],r._$AI(s),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let r=ar(t).nextSibling;ar(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},lt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,i,s){this.type=1,this._$AH=I,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=I}_$AI(t,e=this,r,i){let s=this.strings,o=!1;if(s===void 0)t=ct(this,t,e,0),o=!xt(t)||t!==this._$AH&&t!==rt,o&&(this._$AH=t);else{let a=t,c,d;for(t=s[0],c=0;c<s.length-1;c++)d=ct(this,a[r+c],e,c),d===rt&&(d=this._$AH[c]),o||=!xt(d)||d!==this._$AH[c],d===I?t=I:t!==I&&(t+=(d??"")+s[c+1]),this._$AH[c]=d}o&&!i&&this.j(t)}j(t){t===I?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},_e=class extends lt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===I?void 0:t}},fe=class extends lt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==I)}},ye=class extends lt{constructor(t,e,r,i,s){super(t,e,r,i,s),this.type=5}_$AI(t,e=this){if((t=ct(this,t,e,0)??I)===rt)return;let r=this._$AH,i=t===I&&r!==I||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==I&&(r===I||i);i&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},be=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){ct(this,t)}};var wi=ve.litHtmlPolyfillSupport;wi?.(Et,At),(ve.litHtmlVersions??=[]).push("3.3.3");var yr=(n,t,e)=>{let r=e?.renderBefore??t,i=r._$litPart$;if(i===void 0){let s=e?.renderBefore??null;r._$litPart$=i=new At(t.insertBefore(St(),s),s,void 0,e??{})}return i._$AI(n),i};var xe=globalThis,dt=class extends j{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=yr(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return rt}};dt._$litElement$=!0,dt.finalized=!0,xe.litElementHydrateSupport?.({LitElement:dt});var Si=xe.litElementPolyfillSupport;Si?.({LitElement:dt});(xe.litElementVersions??=[]).push("4.2.2");var Ee=(n,t,e)=>n.localize?.(t)||e,ht=(n,t=6,e=2)=>{let r=(n||[]).filter(d=>Number.isFinite(d));if(!r.length)return 0;let i=Math.min(...r),s=Math.max(...r),o=s-i;if(o<=0)return Math.abs(s)>0&&Math.abs(s)<1?e:0;let a=o/Math.max(1,t-1);if(!Number.isFinite(a)||a<=0)return 0;let c=Math.ceil(-Math.log10(a));return Math.max(0,Math.min(e,c))},br=(n,t)=>{let e=/^fortum:price_forecast_([a-z0-9_]+)$/i.exec(n||"");return e?`Price [${String(e[1]||"").toUpperCase()}]`:t===0?"Price":`Price ${t+1}`},ut=(n,t)=>{if(!n||!t)return!1;let e=s=>String(s).split(".").map(o=>parseInt(o,10)||0),r=e(n),i=e(t);for(let s=0;s<Math.max(r.length,i.length);s++){let o=r[s]||0,a=i[s]||0;if(o>a)return!0;if(o<a)return!1}return!0};var xi=n=>typeof n=="string"&&/^[^:]*fortum:hourly_consumption_/.test(n),Ht=class extends HTMLElement{setConfig(t){this._config=t||{},this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
        <style>
          :host {
            display: block;
            height: 100%;
