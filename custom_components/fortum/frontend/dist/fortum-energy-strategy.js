      ...
      <section class="point" data-point-index="${e}">
        ...
        <div class="field">
          ...
          <select id="point-number-${e}" class="input" data-field="point_number" data-point-index="${e}">
            ...
            ${a?`<option value="${j(a.number)}" selected>${j(a.label)}</option>`:""}
            ${i.map(u=>`<option value="${j(u.number)}" ${u.number===s?"selected":""}>${j(u.label)}</option>`).join("")}
          </select>
          ${c.number?`<div class="hint error-hint">${j(c.number)}</div>`:""}
        </div>

        <div class="field">
          <label class="label" for="point-name-${e}">Display name</label>
          <input id="point-name-${e}" class="input" data-field="point_name" data-point-index="${e}" type="text" placeholder="Name (optional)" value="${j(t?.name||"")}" />
        </div>
        ...
        <div class="field">
          ...
          ${d?r?`<ha-statistic-picker
                    ...
                    data-point-index="${e}"
                    hide-clear-icon
                  ></ha-statistic-picker>`:`<input id="point-temperature-${e}" class="input" data-field="point_temperature" data-point-index="${e}" type="text" placeholder="Temperature source" value="${j(t?.temperature||"")}" />`:""}
        </div>
      ...
      <div class="wrapper">
        <div class="field">
          ...
          >
            ...
            ${s?`<option value="${W(s.number)}" selected>${W(s.label)}</option>`:""}
            ${e.map(c=>`<option
                  value="${W(c.number)}"
                  ${c.number===r?"selected":""}
                >${W(c.label)}</option>`).join("")}
          </select>
          <div class="hint">
        ...
        <div class="field">
          ...
          <input
            ...
            type="text"
            placeholder="Name (optional)"
            value="${W(this._state.meteringPointName||"")}"
          />
        </div>
        ...
        <div class="field">
          ...
          ${this._temperatureOverrideEnabled?t?`<ha-statistic-picker
                  ...
                  ></ha-statistic-picker>`:`<input
                    ...
                    value="${W(this._state.meteringPointTemperature||"")}"
                  />`:""}
        </div>
